...
$boleto = new Eduardokum\LaravelBoleto\Boleto\Banco\Banrisul([
    ...
    'agencia' => 1111,
    'agenciaDv' => 11,
    'conta' => \Eduardokum\LaravelBoleto\Util::contaBanrisul('111122222222222'), // Gera o número da conta a partir do numero do CEDENTE(dev 11 à 15 dígitos) informado pelo banco
    'contaDv' => \Eduardokum\LaravelBoleto\Util::contaBanrisul('111122222222222', 'contaDv'), // Gera o DV da conta a partir do numero do CEDENTE(dev 11 à 15 dígitos) informado pelo banco
