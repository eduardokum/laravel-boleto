...
class Santander extends AbstractRemessa implements RemessaContract
{
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        ...
        $this->add(63, 70, substr(substr(Util::onlyNumbers($boleto->getNossoNumero()), 0, -1), -8));
        $this->add(71, 76, '000000');
        $this->add(77, 77, '');
        $this->add(78, 78, (number_format($boleto->getMulta() * 100, 2) > 0 ? '4' : '0'));
        $this->add(79, 82, Util::formatCnab(
            '9',
            $multa,
            4,
            2
        ...
        $this->add(386, 391, '');
        $this->add(392, 393, Util::formatCnab('9', $boleto->getDiasProtesto() ?: $boleto->getDiasProtesto('0'), 2));
        $this->add(394, 394, '');
