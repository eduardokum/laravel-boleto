...
class Inter extends AbstractRemessa implements RemessaContract
{
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        ...
        $this->add(157, 159, '');
        $this->add(160, 160, $boleto->getJuros() > 0 ? 1 : 0);
        $this->add(161, 173, Util::formatCnab('9', $boleto->getMoraDia(), 13, 2));
        $this->add(174, 177, '0000');
        $this->add(178, 183, $boleto->getJuros() > 0 ? $boleto->getDataVencimento()->addDays($boleto->getJurosApos() > 0 ? $boleto->getJurosApos() : 1)->format('dmy') : '000000');
