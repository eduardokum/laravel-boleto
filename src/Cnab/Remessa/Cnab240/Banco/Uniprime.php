...
/**
 * Class Uniprime
 * @package Eduardokum\LaravelBoleto\Cnab\Remessa\Cnab240\Banco
 */
class Uniprime extends AbstractRemessa implements RemessaContract
{
     ...
     * @var string
     */
    protected $codigoBanco = BoletoContract::COD_BANCO_UNIPRIME;
