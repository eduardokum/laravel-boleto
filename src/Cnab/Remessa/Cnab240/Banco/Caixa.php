...
class Caixa extends AbstractRemessa implements RemessaContract
{
    ...
    public function segmentoR(BoletoContract $boleto)
    {
        ...
        $this->add(9, 13, Util::formatCnab('9', $this->iRegistrosLote, 5));
        $this->add(14, 14, 'R');
        $this->add(15, 15, '');$this->add(67, 74, $boleto->getMulta() > 0 ?  $boleto->getDataVencimento()->copy()->addDay($boleto->getMultaApos())->format('dmY') : '00000000');
        ...
        $this->add(67, 74, $boleto->getMulta() > 0 ?  $boleto->getDataVencimento()->copy()->addDay($boleto->getMultaApos())->format('dmY') : '00000000');
