...
class PdfCaixa extends AbstractPdf implements PdfContract
{
    ...
    protected function Topo($i)
    {
      //primeira linha
         ...
         $this->Cell(35, $this->cell, $this->_($this->boleto[$i]->getAgenciaCodigoBeneficiario()), 'R',1);
         ...
         $this->SetFont($this->PadraoFont, '', $this->fcel);
         $this->Cell(100, $this->cell, $this->_($this->boleto[$i]->getPagador()->getNome()), 'BL');
         $this->Cell(30, $this->cell, $this->_($this->boleto[$i]->getPagador()->getDocumento()), 'B');
         $this->Cell(10, $this->cell, $this->_($this->boleto[$i]->getPagador()->getUf()), 'B');
         $this->Cell(30, $this->cell, $this->_($this->boleto[$i]->getPagador()->getCep()), 'BR',1);
    ...
    protected function Bottom($i)
    {
        ...
        $this->Cell(50, $this->cell, $this->_($this->boleto[$i]->getAgenciaCodigoBeneficiario()), 'LR', 1,'R');
        $this->SetFont($this->PadraoFont, 'B', $this->fcel);
